...
/// <summary>A paginated page of scoped files, with the encoded cursor and skip count.</summary>
...
/// <param name="SkippedSymlinks">The count of symlinked entries pruned during the walk.</param>
