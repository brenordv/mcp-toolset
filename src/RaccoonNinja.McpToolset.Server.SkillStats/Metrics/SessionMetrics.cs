...
/// <c>store_unavailable</c>, <c>internal_error</c>), emitted as a single <c>metrics_summary</c> on the
...
public sealed class SessionMetrics
{
    ...
    /// <param name="outcome">The call outcome (<c>ok</c>, <c>invalid_argument</c>, <c>store_unavailable</c>, <c>internal_error</c>).</param>
