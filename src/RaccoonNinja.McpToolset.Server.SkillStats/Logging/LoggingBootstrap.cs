...
/// <c>mcp-skill-stats.log</c> next to the executable), and a stderr fallback when the file cannot be
/// opened. Honors <c>MCP_SKILLSTATS_LOG_FILE</c> / <c>MCP_SKILLSTATS_LOG_LEVEL</c>. Never writes to
...
public static class LoggingBootstrap
{
    ...
    /// <summary>The default log path: <c>&lt;executable-dir&gt;/mcp-skill-stats.log</c>.</summary>
