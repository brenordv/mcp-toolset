...
/// while rejecting every <c>Write*</c>/<c>WriteLine*</c> call. The MCP SDK writes JSON-RPC frames
/// via the underlying <see cref="Console.OpenStandardOutput()"/> stream, which this wrapper never
/// touches. A stray <c>Console.WriteLine</c> or a default logging provider aimed at stdout throws
/// at the call site instead of corrupting the JSON-RPC stream.
/// </summary>
